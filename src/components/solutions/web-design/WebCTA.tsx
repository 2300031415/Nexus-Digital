      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="max-w-md">
          <h2 className="text-white text-3xl font-extrabold leading-tight">
            ...
            <br />
            <span className="text-nexus-blue"> Actually Converts</span>?
          </h2>
          <p className="text-gray-400 text-sm mt-3 leading-relaxed">
            Let&apos;s create a high-performance website designed to generate leads and grow your business.
          </p>
        </div>
        <div className="flex flex-col items-center gap-4">
          ...
          >
            Book Your Free Website Strategy Call <FiArrowRight />
          </motion.button>
